...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-md bg-ot-surface-top border border-ot-border p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
